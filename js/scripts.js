...
const store = {
  clients: [
    {
      ...
      parent2: { idCard: "12345678R", name: "Juan XXIII", age: 28 },
      children: [
    ...
    },
    {
      ...
      parent2: { idCard: "32456333G", name: "Maria Magdalena", age: 28 },
      children: [
        { idCard: "32456333H", name: "Jorge", age: 7 },
    ...
    },
    {
      ...
      parent2: { idCard: "32456333K", name: "Juana daPaña", age: 28 },
    ...
    },
    {
      ...
      parent2: { idCard: "32456333N", name: "Pedro Duque", age: 28 },
      children: [
  ...
  iva: { value: "21%", operator: 1.21 },
};

// console.log(checkIn([2, 3]));
...
// console.log(store.clients);
// console.log(store.rooms);
// console.log(changeRoom(101));
// console.log(store.clients);
// console.log(store.rooms);
console.log(showInvoice(store.clients[1], "2020/06/22"));
